...
class Particle {
    ...
    draw(ctx: CanvasRenderingContext2D) {
        ...
        // Check if we can get this from CSS variable, but for now using the scaffold value
        // or a neutral blue that usually works well.
        // hsl(217, 91%, 60%) is a bright blue.
